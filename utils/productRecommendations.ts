...
export const generateProductRecommendations = async (
  ...
  const productTemplates: Record<string, any> = {
    ...
    shoes: {
      male: {
        professional: [
          { name: 'Oxford Leather Shoes - Black', image: 'https://images.unsplash.com/photo-1533867617858-e7b97e060509?w=400&h=400&fit=crop' },
          { name: 'Derby Formal Shoes - Brown', image: 'https://images.unsplash.com/photo-1614252235316-8c857d38b5f4?w=400&h=400&fit=crop' },
          { name: 'Brogue Leather Shoes - Tan', image: 'https://images.unsplash.com/photo-1582897085656-c61a42d241e9?w=400&h=400&fit=crop' },
          { name: 'Classic Oxford - Dark Brown', image: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Casual Sneakers - White', image: 'https://images.unsplash.com/photo-1542291026-7eec264c27ff?w=400&h=400&fit=crop' },
          { name: 'Canvas Shoes - Navy Blue', image: 'https://images.unsplash.com/photo-1460353581641-37baddab0fa2?w=400&h=400&fit=crop' },
          { name: 'Loafers - Brown Suede', image: 'https://images.unsplash.com/photo-1533867617858-e7b97e060509?w=400&h=400&fit=crop' },
          { name: 'Slip-On Sneakers - Grey', image: 'https://images.unsplash.com/photo-1525966222134-fcfa99b8ae77?w=400&h=400&fit=crop' },
        ],
      },
      female: {
        professional: [
          { name: 'Classic Pumps - Black', image: 'https://images.unsplash.com/photo-1543163521-1bf539c55dd2?w=400&h=400&fit=crop' },
          { name: 'Pointed Toe Heels - Nude', image: 'https://images.unsplash.com/photo-1596702612440-a64de2c797fb?w=400&h=400&fit=crop' },
          { name: 'Block Heel Pumps - Navy', image: 'https://images.unsplash.com/photo-1603808033176-c49e5e4e14cc?w=400&h=400&fit=crop' },
          { name: 'Kitten Heels - Black', image: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Ballet Flats - Nude', image: 'https://images.unsplash.com/photo-1603808033176-c49e5e4e14cc?w=400&h=400&fit=crop' },
          { name: 'Loafers - Brown', image: 'https://images.unsplash.com/photo-1560343090-f0409e92791a?w=400&h=400&fit=crop' },
          { name: 'White Sneakers', image: 'https://images.unsplash.com/photo-1515347619252-60a4bf4fff4f?w=400&h=400&fit=crop' },
          { name: 'Sandals - Tan', image: 'https://images.unsplash.com/photo-1603808033176-c49e5e4e14cc?w=400&h=400&fit=crop' },
        ],
      },
    },
    blazer: {
      male: {
        professional: [
          { name: 'Slim Fit Blazer - Navy', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400&h=400&fit=crop' },
          { name: 'Formal Blazer - Charcoal Grey', image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&h=400&fit=crop' },
          { name: 'Business Blazer - Black', image: 'https://images.unsplash.com/photo-1593030668469-d6cf1c5c825f?w=400&h=400&fit=crop' },
          { name: 'Tailored Blazer - Dark Blue', image: 'https://images.unsplash.com/photo-1591047139829-d91aecb6caea?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Casual Blazer - Light Grey', image: 'https://images.unsplash.com/photo-1594938291221-94f18cbb5660?w=400&h=400&fit=crop' },
          { name: 'Linen Blazer - Beige', image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&h=400&fit=crop' },
          { name: 'Cotton Blazer - Navy Blue', image: 'https://images.unsplash.com/photo-1593030668469-d6cf1c5c825f?w=400&h=400&fit=crop' },
          { name: 'Sport Coat - Brown', image: 'https://images.unsplash.com/photo-1594938298603-c8148c4dae35?w=400&h=400&fit=crop' },
        ],
      },
      female: {
        professional: [
          { name: 'Tailored Blazer - Black', image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=400&h=400&fit=crop' },
          { name: 'Professional Blazer - Navy', image: 'https://images.unsplash.com/photo-1594938384889-e32be6c28c1d?w=400&h=400&fit=crop' },
          { name: 'Women\'s Suit Jacket - Grey', image: 'https://images.unsplash.com/photo-1615555697554-d2a004024926?w=400&h=400&fit=crop' },
          { name: 'Business Blazer - White', image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Casual Blazer - Beige', image: 'https://images.unsplash.com/photo-1594938384889-e32be6c28c1d?w=400&h=400&fit=crop' },
          { name: 'Linen Blazer - Light Pink', image: 'https://images.unsplash.com/photo-1615555697554-d2a004024926?w=400&h=400&fit=crop' },
          { name: 'Relaxed Fit Blazer - Brown', image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=400&h=400&fit=crop' },
          { name: 'Oversized Blazer - Cream', image: 'https://images.unsplash.com/photo-1594938384889-e32be6c28c1d?w=400&h=400&fit=crop' },
        ],
      },
    },
    shirt: {
      male: {
        professional: [
          { name: 'Formal White Shirt - Cotton', image: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&h=400&fit=crop' },
          { name: 'Blue Oxford Shirt', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=400&h=400&fit=crop' },
          { name: 'Striped Formal Shirt - Blue', image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=400&h=400&fit=crop' },
          { name: 'Classic White Shirt - Slim Fit', image: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Linen Casual Shirt - White', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=400&h=400&fit=crop' },
          { name: 'Denim Shirt - Light Blue', image: 'https://images.unsplash.com/photo-1620799140408-edc6dcb6d633?w=400&h=400&fit=crop' },
          { name: 'Checkered Shirt - Blue', image: 'https://images.unsplash.com/photo-1602810318383-e386cc2a3ccf?w=400&h=400&fit=crop' },
          { name: 'Casual Cotton Shirt - Grey', image: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=400&h=400&fit=crop' },
        ],
      },
      female: {
        professional: [
          { name: 'Silk Blouse - White', image: 'https://images.unsplash.com/photo-1578932750355-5eb30ece487a?w=400&h=400&fit=crop' },
          { name: 'Formal Blouse - Black', image: 'https://images.unsplash.com/photo-1564257577-05772b52e6c4?w=400&h=400&fit=crop' },
          { name: 'Button-Up Shirt - Light Blue', image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=400&h=400&fit=crop' },
          { name: 'Office Blouse - Navy', image: 'https://images.unsplash.com/photo-1578932750355-5eb30ece487a?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Casual Blouse - Floral', image: 'https://images.unsplash.com/photo-1564257577-05772b52e6c4?w=400&h=400&fit=crop' },
          { name: 'Relaxed Shirt - White', image: 'https://images.unsplash.com/photo-1591369822096-ffd140ec948f?w=400&h=400&fit=crop' },
          { name: 'Chambray Shirt - Light Blue', image: 'https://images.unsplash.com/photo-1578932750355-5eb30ece487a?w=400&h=400&fit=crop' },
          { name: 'Casual Top - Striped', image: 'https://images.unsplash.com/photo-1564257577-05772b52e6c4?w=400&h=400&fit=crop' },
        ],
      },
    },
    kurta: {
    ...
    bag: {
      male: {
        professional: [
          { name: 'Leather Briefcase - Black', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=400&fit=crop' },
          { name: 'Laptop Bag - Brown Leather', image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop' },
          { name: 'Professional Messenger Bag - Navy', image: 'https://images.unsplash.com/photo-1575403071235-11a87c24e7e3?w=400&h=400&fit=crop' },
          { name: 'Business Bag - Dark Grey', image: 'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Canvas Backpack - Grey', image: 'https://images.unsplash.com/photo-1553062407-98eeb64c6a62?w=400&h=400&fit=crop' },
          { name: 'Messenger Bag - Brown Canvas', image: 'https://images.unsplash.com/photo-1575403071235-11a87c24e7e3?w=400&h=400&fit=crop' },
          { name: 'Duffle Bag - Black', image: 'https://images.unsplash.com/photo-1548036328-c9fa89d128fa?w=400&h=400&fit=crop' },
          { name: 'Sling Bag - Navy', image: 'https://images.unsplash.com/photo-1622560480605-d83c853bc5c3?w=400&h=400&fit=crop' },
        ],
      },
      female: {
        professional: [
          { name: 'Structured Tote - Black Leather', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&h=400&fit=crop' },
          { name: 'Professional Satchel Handbag - Brown', image: 'https://images.unsplash.com/photo-1564422170194-896b89110ef8?w=400&h=400&fit=crop' },
          { name: 'Work Tote Bag - Navy Blue', image: 'https://images.unsplash.com/photo-1591561954555-607968a5f865?w=400&h=400&fit=crop' },
          { name: 'Leather Handbag - Camel', image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Crossbody Bag - Tan', image: 'https://images.unsplash.com/photo-1564422170194-896b89110ef8?w=400&h=400&fit=crop' },
          { name: 'Hobo Bag - Beige', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&h=400&fit=crop' },
          { name: 'Bucket Bag - Black', image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&h=400&fit=crop' },
          { name: 'Canvas Tote - Grey', image: 'https://images.unsplash.com/photo-1591561954555-607968a5f865?w=400&h=400&fit=crop' },
        ],
      },
    },
    watch: {
      male: {
        professional: [
          { name: 'Formal Watch - Silver', image: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=400&h=400&fit=crop' },
          { name: 'Classic Watch - Black Leather', image: 'https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=400&h=400&fit=crop' },
          { name: 'Business Watch - Gold', image: 'https://images.unsplash.com/photo-1622434641406-a158123450f9?w=400&h=400&fit=crop' },
          { name: 'Executive Watch - Silver', image: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Sport Watch - Black', image: 'https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=400&h=400&fit=crop' },
          { name: 'Casual Watch - Brown Strap', image: 'https://images.unsplash.com/photo-1622434641406-a158123450f9?w=400&h=400&fit=crop' },
          { name: 'Digital Watch - Silver', image: 'https://images.unsplash.com/photo-1524805444758-089113d48a6d?w=400&h=400&fit=crop' },
          { name: 'Canvas Strap Watch - Blue', image: 'https://images.unsplash.com/photo-1523170335258-f5ed11844a49?w=400&h=400&fit=crop' },
        ],
      },
      female: {
        professional: [
          { name: 'Elegant Watch - Rose Gold', image: 'https://images.unsplash.com/photo-1539874754764-5a96559165b0?w=400&h=400&fit=crop' },
          { name: 'Minimalist Watch - Silver', image: 'https://images.unsplash.com/photo-1594576722512-582bcd46fba3?w=400&h=400&fit=crop' },
          { name: 'Classic Watch - Gold Bracelet', image: 'https://images.unsplash.com/photo-1539874754764-5a96559165b0?w=400&h=400&fit=crop' },
          { name: 'Business Watch - Two-Tone', image: 'https://images.unsplash.com/photo-1594576722512-582bcd46fba3?w=400&h=400&fit=crop' },
        ],
        casual: [
          { name: 'Fashion Watch - Rose Gold', image: 'https://images.unsplash.com/photo-1594576722512-582bcd46fba3?w=400&h=400&fit=crop' },
          { name: 'Casual Watch - Leather Strap', image: 'https://images.unsplash.com/photo-1539874754764-5a96559165b0?w=400&h=400&fit=crop' },
          { name: 'Sporty Watch - White', image: 'https://images.unsplash.com/photo-1594576722512-582bcd46fba3?w=400&h=400&fit=crop' },
          { name: 'Trendy Watch - Gold', image: 'https://images.unsplash.com/photo-1539874754764-5a96559165b0?w=400&h=400&fit=crop' },
        ],
      },
    },
    ...
    handbag: {
      professional: [
        { name: 'Structured Tote - Black Leather', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&h=400&fit=crop' },
        { name: 'Professional Satchel Handbag - Brown', image: 'https://images.unsplash.com/photo-1564422170194-896b89110ef8?w=400&h=400&fit=crop' },
        { name: 'Work Tote Handbag - Navy Blue', image: 'https://images.unsplash.com/photo-1591561954555-607968a5f865?w=400&h=400&fit=crop' },
        { name: 'Leather Handbag - Camel', image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&h=400&fit=crop' },
      ],
      casual: [
        { name: 'Crossbody Handbag - Tan', image: 'https://images.unsplash.com/photo-1564422170194-896b89110ef8?w=400&h=400&fit=crop' },
        { name: 'Hobo Handbag - Beige', image: 'https://images.unsplash.com/photo-1590874103328-eac38a683ce7?w=400&h=400&fit=crop' },
        { name: 'Bucket Handbag - Black', image: 'https://images.unsplash.com/photo-1566150905458-1bf1fc113f0d?w=400&h=400&fit=crop' },
        { name: 'Canvas Tote Bag - Grey', image: 'https://images.unsplash.com/photo-1591561954555-607968a5f865?w=400&h=400&fit=crop' },
      ],
    },
    bracelet: {
      professional: [
